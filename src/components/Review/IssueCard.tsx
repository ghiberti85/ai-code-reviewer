...
export function IssueCard({ issue, index }: Props) {
  ...
  return (
    ...
    >
      ...
      <div style={{ background: '#0D0F0E', borderRadius: '4px', padding: '8px 12px' }}>
        <span style={{ color: '#8A9E95', fontFamily: 'JetBrains Mono, monospace', fontSize: '11px' }}>fix → </span>
        <span style={{ color: '#00FF88', fontFamily: 'JetBrains Mono, monospace', fontSize: '12px', whiteSpace: 'pre-wrap' }}>
          {issue.fix}
        </span>
      </div>
    </motion.div>
